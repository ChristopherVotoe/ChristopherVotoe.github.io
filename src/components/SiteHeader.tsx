...
export function SiteHeader({ current = "home" }: { current?: "home" | "record" | "results" }) {
  return <header className="site-header">
    ...
    <nav aria-label="Main navigation"><Link href="/" aria-current={current === "home" ? "page" : undefined}>Home</Link><Link href="/results" aria-current={current === "results" ? "page" : undefined}>My recording</Link><Link href="/#how-it-works">Help</Link></nav>
