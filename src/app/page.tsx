import { VideoPrivacy } from "@/components/VideoEmail";
  ...
  return <main className="landing-page">
    ...
    <section className="landing-hero">
      ...
      <p>Getting started? Just enable the camera and follow the instructions.</p>
        <TestNowButton /><p className="start-disclosure">This test records your camera. <VideoPrivacy /> No microphone audio. You can stop at any time.</p>
